...
public abstract class AdOptions {
    ...
    private AdOptions(PluginCall call) {
        ...
        String sizeString = call.getString("adSize", "somebanner size");
        this.adSize = sizeString;
    }

    private AdOptions(String id, boolean isTesting, String position, int margin, boolean npa, String adSize) {
        this.adId = id;
    ...
    private static String adSizeStringToAdSizeEnum(String sizeString) {
        try {
            return  sizeString ;
    ...
    public static class TesterAdOptionsBuilder {
        ...
        public TesterAdOptionsBuilder setAdSize(String value) {
            adSize = value;
            return this;
        }
